...
- **Phase 3 批次 B(v0.7.0)**:🚧 进行中(RFC 三·B 节细则已补,2026-07-08)
  ...
  - B11 OLED SSD1306 ✅(TWI 从机 + 128×64 帧缓冲 + 盲文降采样;CI "oled ok" 关卡,2026-07-12)
  - **批次 B 完工 = 任务书 13 件外设 100% 处置(完成 10 + 豁免 3:ESP32/Pico/F103)**;剩 tag `v0.7.0`(需用户授权)
...
- 元件 17 种(led / rgb_led / button / resistor / buzzer / potentiometer / photoresistor / servo / dc_motor / ultrasonic / dht11 / ir_receiver / lcd1602 / oled_ssd1306 / seven_segment / breadboard / dupont),经 `src/components/` 注册式接入
...
examples/           ≤20 个(已到上限,当前 20),新增需含 README + moxin.toml
